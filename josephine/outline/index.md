...
|---|---|---|---|
| Total | 63 / 441 | 64 / 444 | +3 raw, +3 scaled |
| ELA | 37 / 240 | 28 / 208 | -9 raw, -32 scaled |
| Math | 26 / 201 | 36 / 236 | +10 raw, +35 scaled |

Because both exams sit roughly 55–65 scaled points below the most accessible specialized school cutoff (Brooklyn Latin, ~496), the study plan below is built to close a gap of at least 50–110 points depending on target school, with a required rebalancing toward ELA to prevent further erosion.

## Diagnosing the Root Causes

### Math: Real Gains, But New Gaps Opened

Math domain accuracy across the two tests shows the following pattern (percent correct, March vs. June):

| Math Domain | March | June | Trend |
|---|---|---|---|
| Arithmetic | 100 | 25 | Sharp decline |
| Measurements | 100 | 0 | Sharp decline |
| Data/Statistics | 33.33 | 0 | Sharp decline |
| Geometry | 36.36 | 27.27 | Persistent weakness |
| Percents | 57.14 | 28.57 | Decline |
| Inequalities | 20 | 20 | Persistent weakness |
| Word Problems | 37.5 | 62.5 | Improved |
| Factors/Multiples | 33.33 | 66.67 | Improved |
| Probability | 11.11 | 66.67 | Strong improvement |
...
ELA question-type accuracy tells an even clearer story:

| ELA Skill | March | June | Trend |
|---|---|---|---|
| Connecting Specific Info to Main Purpose | 23.08 | 7.69 | Critical weakness |
| Analyzing Organization/Structure | 57.14 | 14.29 | Sharp decline |
| Main Idea | 25 | 50 | Improved but still weak |
| Writing (Revising/Editing) | 90 | 40 | Sharp decline |
| Vocab in Context | 50 | 50 | Persistent weakness |
| Inference | 20 | 100 | Volatile — likely passage-dependent, not mastery |
| Detail | 84.62 | 69.23 | Still a relative strength |
| Fiction passages | 33.33 | 22.22 | Persistent weakness |
...
| Priority | Area | Why |
|---|---|---|
| 1 | Connecting Info to Main Purpose (ELA) | Near-single-digit accuracy on both tests; core inferential skill gap |
| 2 | Analyzing Organization/Structure (ELA) | Dropped from 57 to 14 percent; passage-level reasoning gap |
| 3 | Writing/Revising-Editing (ELA) | Dropped from 90 to 40 percent; should be a stable strength, currently unstable |
| 4 | Geometry (Math) | Flat/declining across both tests; conceptual gap, not just practice gap |
| 5 | Inequalities (Math) | Flat at 20 percent; unresolved conceptual gap |
| 6 | Arithmetic/Measurements (Math) | Collapsed from 100 percent; likely careless errors from mixed-practice fatigue |
